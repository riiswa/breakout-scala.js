...
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_ActionListener$() {
  $c_O.call(this)
}
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_ActionListener$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_ActionListener$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_ActionListener$.prototype = $c_Lcom_github_breakout$undscalajs_ActionListener$.prototype;
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.com$github$breakout$undscalajs$ActionListener$$$anonfun$setKeyHandler$1__Lorg_scalajs_dom_raw_Event__V = (function(event) {
  var paddle = $m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1;
  var x1 = $uI(event.keyCode);
  switch (x1) {
    case 39: {
      if ((paddle.x$1 < (($uI($m_Lcom_github_breakout$undscalajs_Drawer$().canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().width) - paddle.paddleWidth$1) | 0))) {
        var jsx$1 = $m_Lcom_github_breakout$undscalajs_Drawer$();
        var x = ((paddle.x$1 + $m_Lcom_github_breakout$undscalajs_Global$().paddlePower$1) | 0);
        jsx$1.paddle$1 = new $c_Lcom_github_breakout$undscalajs_Paddle().init___I(x)
      } else {
        break
      };
      break
    ...
    case 37: {
      if ((paddle.x$1 > 0)) {
        var jsx$2 = $m_Lcom_github_breakout$undscalajs_Drawer$();
        var x$1 = ((paddle.x$1 - $m_Lcom_github_breakout$undscalajs_Global$().paddlePower$1) | 0);
        jsx$2.paddle$1 = new $c_Lcom_github_breakout$undscalajs_Paddle().init___I(x$1)
      } else {
        break
      };
      break
...
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.setMouseHandler__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("mousemove", (function(arg1$2) {
    $m_Lcom_github_breakout$undscalajs_ActionListener$().com$github$breakout$undscalajs$ActionListener$$$anonfun$setMouseHandler$1__Lorg_scalajs_dom_raw_Event__V(arg1$2)
  }), false)
});
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.setKeyHandler__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("keydown", (function(arg1$2) {
    $m_Lcom_github_breakout$undscalajs_ActionListener$().com$github$breakout$undscalajs$ActionListener$$$anonfun$setKeyHandler$1__Lorg_scalajs_dom_raw_Event__V(arg1$2)
  }), false)
});
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.com$github$breakout$undscalajs$ActionListener$$$anonfun$setMouseHandler$1__Lorg_scalajs_dom_raw_Event__V = (function(event) {
  var paddle = $m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1;
  var relativeX = ($uD(event.clientX) - $uD($m_Lcom_github_breakout$undscalajs_Drawer$().canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().offsetLeft));
  if (((relativeX > 0) && (relativeX < $uI($m_Lcom_github_breakout$undscalajs_Drawer$().canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().width)))) {
    var jsx$1 = $m_Lcom_github_breakout$undscalajs_Drawer$();
    var x = (($doubleToInt(relativeX) - ((paddle.paddleWidth$1 / 2) | 0)) | 0);
    jsx$1.paddle$1 = new $c_Lcom_github_breakout$undscalajs_Paddle().init___I(x)
  }
});
var $d_Lcom_github_breakout$undscalajs_ActionListener$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_ActionListener$: 0
}, false, "com.github.breakout_scalajs.ActionListener$", {
  Lcom_github_breakout$undscalajs_ActionListener$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_ActionListener$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_ActionListener$;
var $n_Lcom_github_breakout$undscalajs_ActionListener$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_ActionListener$() {
  if ((!$n_Lcom_github_breakout$undscalajs_ActionListener$)) {
    $n_Lcom_github_breakout$undscalajs_ActionListener$ = new $c_Lcom_github_breakout$undscalajs_ActionListener$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_ActionListener$
}
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_App$() {
  $c_O.call(this)
}
$c_Lcom_github_breakout$undscalajs_App$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_App$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_App$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_App$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_App$.prototype = $c_Lcom_github_breakout$undscalajs_App$.prototype;
$c_Lcom_github_breakout$undscalajs_App$.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_breakout$undscalajs_App$.prototype.main__AT__V = (function(args) {
  $m_Lcom_github_breakout$undscalajs_ActionListener$().setKeyHandler__V();
  $m_Lcom_github_breakout$undscalajs_ActionListener$().setMouseHandler__V();
  $m_Lcom_github_breakout$undscalajs_Global$().refreshId$1 = $m_sjs_js_timers_package$().setInterval__D__F0__sjs_js_timers_SetIntervalHandle(10.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
    return (function() {
      $m_Lcom_github_breakout$undscalajs_Drawer$().draw__V()
    })
  })(this)))
});
var $d_Lcom_github_breakout$undscalajs_App$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_App$: 0
}, false, "com.github.breakout_scalajs.App$", {
  Lcom_github_breakout$undscalajs_App$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_App$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_App$;
var $n_Lcom_github_breakout$undscalajs_App$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_App$() {
  if ((!$n_Lcom_github_breakout$undscalajs_App$)) {
    $n_Lcom_github_breakout$undscalajs_App$ = new $c_Lcom_github_breakout$undscalajs_App$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_App$
}
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_CollisionManager$() {
  $c_O.call(this)
}
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_CollisionManager$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_CollisionManager$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_CollisionManager$.prototype = $c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype;
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.updateBall__Lcom_github_breakout$undscalajs_Ball__s_Option = (function(ball) {
  var ballBetweenPaddle = ((ball.x$1 > (((-5) + $m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1.x$1) | 0)) && (ball.x$1 < ((5 + (($m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1.x$1 + $m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1.paddleWidth$1) | 0)) | 0)));
  var gameOverCondition = (((ball.y$1 + ball.dy$1) | 0) > (($uI($m_Lcom_github_breakout$undscalajs_Drawer$().canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().height) - ball.radius$1) | 0));
  var xs = $m_Lcom_github_breakout$undscalajs_Drawer$().bricks$1;
  var end = xs.u.length;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      var arg1 = i;
      var xs$1 = $m_Lcom_github_breakout$undscalajs_Drawer$().bricks$1;
      var this$10 = new $c_scm_ArrayOps$ofRef().init___AO(xs$1);
      var xs$2 = $asArrayOf_Z($f_sc_IndexedSeqOptimized__head__O(this$10), 1);
      var end$1 = xs$2.u.length;
      var this$17 = new $c_sci_Range().init___I__I__I(0, end$1, 1);
      var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, c) {
        return (function(r$2) {
          var r = $uI(r$2);
          if ($m_Lcom_github_breakout$undscalajs_CollisionManager$().isCollideBrick__I__I__Z(c, r)) {
            $m_Lcom_github_breakout$undscalajs_Drawer$().bricks$1.get(c).set(r, false);
            $m_Lcom_github_breakout$undscalajs_Score$().score$1 = (($m_Lcom_github_breakout$undscalajs_Score$().score$1 + $m_Lcom_github_breakout$undscalajs_Score$().coeff$1) | 0);
            $m_Lcom_github_breakout$undscalajs_Score$().coeff$1 = ((1 + $m_Lcom_github_breakout$undscalajs_Score$().coeff$1) | 0);
            return true
          } else {
            return false
          }
      ...
      var elem = $as_sci_IndexedSeq($f_sc_TraversableLike__map__F1__scg_CanBuildFrom__O(this$17, f, bf$1));
  ...
  var this$20 = this$18.iterator__sci_VectorIterator();
  while (this$20.$$undhasNext$2) {
    var arg1$1 = this$20.next__O();
    var xs$3 = $as_sc_GenTraversableOnce(arg1$1).seq__sc_TraversableOnce();
    $as_sci_VectorBuilder($f_scg_Growable__$$plus$plus$eq__sc_TraversableOnce__scg_Growable(b$1, xs$3))
  };
  var bricksCollision = b$1.result__sci_Vector();
  if ((gameOverCondition && (!ballBetweenPaddle))) {
    return $m_s_None$()
  } else {
    if ((gameOverCondition && ballBetweenPaddle)) {
      $m_Lcom_github_breakout$undscalajs_Score$().coeff$1 = 1;
      $m_Lcom_github_breakout$undscalajs_Global$().paddleWidth$1 = (((-4) + $m_Lcom_github_breakout$undscalajs_Global$().paddleWidth$1) | 0);
      var jsx$1 = ((ball.dx$1 + ((((-(((($m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1.x$1 + (($m_Lcom_github_breakout$undscalajs_Drawer$().paddle$1.paddleWidth$1 / 2) | 0)) | 0) - ball.x$1) | 0)) | 0) / 6) | 0)) | 0)
    } else {
      var jsx$1 = this.dx$1__p1__Lcom_github_breakout$undscalajs_Ball__I(ball)
    };
    return new $c_s_Some().init___O(ball.next__I__I__Lcom_github_breakout$undscalajs_Ball(jsx$1, this.dy$1__p1__Lcom_github_breakout$undscalajs_Ball__Z__Z__sc_IndexedSeq__I(ball, gameOverCondition, ballBetweenPaddle, bricksCollision)))
  }
});
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.dx$1__p1__Lcom_github_breakout$undscalajs_Ball__I = (function(ball$1) {
  return (((((ball$1.x$1 + ball$1.dx$1) | 0) > (($uI($m_Lcom_github_breakout$undscalajs_Drawer$().canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().width) - ball$1.radius$1) | 0)) || (((ball$1.x$1 + ball$1.dx$1) | 0) < ball$1.radius$1)) ? ((-ball$1.dx$1) | 0) : ball$1.dx$1)
});
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.dy$1__p1__Lcom_github_breakout$undscalajs_Ball__Z__Z__sc_IndexedSeq__I = (function(ball$1, gameOverCondition$1, ballBetweenPaddle$1, bricksCollision$1) {
  return ((((((ball$1.y$1 + ball$1.dy$1) | 0) < ball$1.radius$1) || (gameOverCondition$1 && ballBetweenPaddle$1)) || $f_sc_SeqLike__contains__O__Z(bricksCollision$1, true)) ? ((-ball$1.dy$1) | 0) : ball$1.dy$1)
});
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.isCollideBrick__I__I__Z = (function(c, r) {
  var b = $as_Lcom_github_breakout$undscalajs_Brick($as_sc_SeqLike($m_Lcom_github_breakout$undscalajs_Drawer$().getBricks__sc_IndexedSeq().apply__I__O(c)).apply__I__O(r));
  return ((((($m_Lcom_github_breakout$undscalajs_Drawer$().ball$1.x$1 > (((-3) + b.x$1) | 0)) && ($m_Lcom_github_breakout$undscalajs_Drawer$().ball$1.x$1 < ((3 + ((b.x$1 + $m_Lcom_github_breakout$undscalajs_Global$().brickWidth$1) | 0)) | 0))) && ($m_Lcom_github_breakout$undscalajs_Drawer$().ball$1.y$1 > b.y$1)) && ($m_Lcom_github_breakout$undscalajs_Drawer$().ball$1.y$1 < ((b.y$1 + $m_Lcom_github_breakout$undscalajs_Global$().brickHeight$1) | 0))) && $m_Lcom_github_breakout$undscalajs_Drawer$().bricks$1.get(c).get(r))
});
var $d_Lcom_github_breakout$undscalajs_CollisionManager$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_CollisionManager$: 0
}, false, "com.github.breakout_scalajs.CollisionManager$", {
  Lcom_github_breakout$undscalajs_CollisionManager$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_CollisionManager$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_CollisionManager$;
var $n_Lcom_github_breakout$undscalajs_CollisionManager$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_CollisionManager$() {
  if ((!$n_Lcom_github_breakout$undscalajs_CollisionManager$)) {
    $n_Lcom_github_breakout$undscalajs_CollisionManager$ = new $c_Lcom_github_breakout$undscalajs_CollisionManager$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_CollisionManager$
}
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_Drawer$() {
  $c_O.call(this);
  this.bricks$1 = null;
  this.colors$1 = null;
  this.ball$1 = null;
...
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_Drawer$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_Drawer$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_Drawer$.prototype = $c_Lcom_github_breakout$undscalajs_Drawer$.prototype;
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement = (function() {
  return $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("myCanvas")
});
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.init___ = (function() {
  $n_Lcom_github_breakout$undscalajs_Drawer$ = this;
  var n1 = $m_Lcom_github_breakout$undscalajs_Global$().brickColumnCount$1;
  var n2 = $m_Lcom_github_breakout$undscalajs_Global$().brickRowCount$1;
  var elems$2 = null;
  elems$2 = [];
  var i = 0;
  while ((i < n1)) {
    ...
    while ((i$1 < n2)) {
      ...
      var elem = (this$12.self$1.nextFloat__F() > 0.4);
      elems$2$1.push(elem);
      i$1 = ((1 + i$1) | 0)
    };
    var elem$1 = $makeNativeArrayWrapper($d_Z.getArrayOf(), elems$2$1);
    elems$2.push(elem$1);
    i = ((1 + i) | 0)
  };
  this.bricks$1 = $makeNativeArrayWrapper($d_Z.getArrayOf().getArrayOf(), elems$2);
  var n1$1 = $m_Lcom_github_breakout$undscalajs_Global$().brickColumnCount$1;
  var n2$1 = $m_Lcom_github_breakout$undscalajs_Global$().brickRowCount$1;
  var elems$2$2 = null;
  elems$2$2 = [];
  var i$2 = 0;
  while ((i$2 < n1$1)) {
    ...
    var i$3 = 0;
    while ((i$3 < n2$1)) {
      var this$27 = new $c_sci_StringOps().init___T("#%06x");
      var this$24 = $m_s_util_Random$();
      var array = [this$24.self$1.nextInt__I__I(16777216)];
      ...
      while ((i$4 < len)) {
        ...
        var elem$2 = $f_sci_StringLike__unwrapArg__psci_StringLike__O__O(this$27, arg1$2);
        array$1.push(elem$2);
        i$4 = ((1 + i$4) | 0)
      };
      ...
      var elem$3 = jsx$2.format__T__AO__T($$this, result);
      var unboxedElem = ((elem$3 === null) ? null : elem$3);
      elems$2$3.push(unboxedElem);
      i$3 = ((1 + i$3) | 0)
    };
    var elem$4 = $makeNativeArrayWrapper($d_T.getArrayOf(), elems$2$3);
    elems$2$2.push(elem$4);
    i$2 = ((1 + i$2) | 0)
  };
  this.colors$1 = $makeNativeArrayWrapper($d_T.getArrayOf().getArrayOf(), elems$2$2);
  this.ball$1 = new $c_Lcom_github_breakout$undscalajs_Ball().init___I__I__I__I((($uI(this.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().width) / 2) | 0), (((-300) + $uI(this.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().height)) | 0), 1, 2);
  this.paddle$1 = new $c_Lcom_github_breakout$undscalajs_Paddle().init___I((((((-75) + $uI(this.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().width)) | 0) / 2) | 0));
  return this
});
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.drawBricks__V = (function() {
  var xs = this.bricks$1;
  var end = xs.u.length;
  var isEmpty$4 = (end <= 0);
  var scala$collection$immutable$Range$$lastElement$4 = (((-1) + end) | 0);
  if ((!isEmpty$4)) {
    ...
    while (true) {
      var v1 = i;
      var xs$1 = $m_Lcom_github_breakout$undscalajs_Drawer$().bricks$1;
      var this$7 = new $c_scm_ArrayOps$ofRef().init___AO(xs$1);
      var xs$2 = $asArrayOf_Z($f_sc_IndexedSeqOptimized__head__O(this$7), 1);
      var end$1 = xs$2.u.length;
      ...
      if ((!isEmpty$4$1)) {
        ...
        while (true) {
          var v1$1 = i$1;
          if ($m_Lcom_github_breakout$undscalajs_Drawer$().bricks$1.get(v1).get(v1$1)) {
            $as_Lcom_github_breakout$undscalajs_Brick($as_sc_SeqLike($m_Lcom_github_breakout$undscalajs_Drawer$().getBricks__sc_IndexedSeq().apply__I__O(v1)).apply__I__O(v1$1)).draw__V()
          };
...
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.getBricks__sc_IndexedSeq = (function() {
  var xs = this.bricks$1;
  var end = xs.u.length;
  var isEmpty$4 = (end <= 0);
  if (isEmpty$4) {
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      ...
      var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, c) {
        return (function(r$2) {
          var r = $uI(r$2);
          return new $c_Lcom_github_breakout$undscalajs_Brick().init___I__I__T(c, r, $m_Lcom_github_breakout$undscalajs_Drawer$().colors$1.get(c).get(r))
        })
      })(this, arg1));
      $m_sci_IndexedSeq$();
      var bf$1 = $m_sc_IndexedSeq$().ReusableCBF$6;
...
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.draw__V = (function() {
  this.clear__V();
  $m_Lcom_github_breakout$undscalajs_Score$().drawScore__V();
  this.ball$1.draw__V();
  this.paddle$1.draw__V();
  this.drawBricks__V();
  var x1 = $m_Lcom_github_breakout$undscalajs_CollisionManager$().updateBall__Lcom_github_breakout$undscalajs_Ball__s_Option(this.ball$1);
  if ((x1 instanceof $c_s_Some)) {
    var x2 = $as_s_Some(x1);
    var updatedBall = $as_Lcom_github_breakout$undscalajs_Ball(x2.value$2);
    $m_Lcom_github_breakout$undscalajs_Drawer$().ball$1 = updatedBall
  } else {
    var this$1 = $m_Lcom_github_breakout$undscalajs_GameUtil$();
    this$1.reload__T__V("GAME OVER !")
  };
  var xs = this.bricks$1;
  var elems$2 = null;
  elems$2 = [];
  ...
  while ((i < len)) {
    ...
    var elem = ($is_sc_IndexedSeq(arg1) ? $as_sc_SeqLike(arg1).size__I() : 0);
    elems$2$1.push(elem);
    i = ((1 + i) | 0)
  };
  var xs$1 = $makeNativeArrayWrapper($d_I.getArrayOf(), elems$2$1);
  ...
  _foldl: while (true) {
    if ((start$1 !== end)) {
      ...
      var arg1$1 = z$1;
      var idx = start$1;
      var arg2 = xs$1.get(idx);
      var x = $uI(arg1$1);
      var temp$z = $f_s_math_Numeric$IntIsIntegral__plus__I__I__I(num, x, arg2);
      start$1 = temp$start;
      z$1 = temp$z;
      continue _foldl
    };
  ...
  while ((i$1 < len$1)) {
    var index$1 = i$1;
    var arg1$2 = xs.get(index$1);
    var xs$2 = $asArrayOf_Z(arg1$2, 1);
    var xs$3 = $m_s_Predef$().wrapBooleanArray__AZ__scm_WrappedArray(xs$2);
    if ($is_sc_LinearSeq(xs$3)) {
      var x2$1 = $as_sc_LinearSeq(xs$3);
      var xs$4 = x2$1;
      var xs$5 = xs$4;
      _loop: while (true) {
        var this$21 = xs$5;
        if ($f_sc_TraversableOnce__nonEmpty__Z(this$21)) {
          var elem$1 = xs$5.head__O();
          var unboxedElem = ((elem$1 === null) ? false : elem$1);
          elems$2.push(unboxedElem);
          xs$5 = $as_sc_LinearSeq(xs$5.tail__O());
          continue _loop
        };
        break
      }
      ...
      while ((i$2 < len$2)) {
        var arg1$3 = xs$3.apply__I__O(i$2);
        var unboxedElem$1 = ((arg1$3 === null) ? false : arg1$3);
  ...
  var xs$6 = $makeNativeArrayWrapper($d_Z.getArrayOf(), elems$2);
  var i$3 = 0;
  while (true) {
    if ((i$3 < xs$6.u.length)) {
      var idx$1 = i$3;
      var arg1$4 = xs$6.get(idx$1);
      var jsx$2 = ((arg1$4 === false) === true)
    } else {
      var jsx$2 = false
    };
    if (jsx$2) {
  ...
  if ((i$3 === xs$6.u.length)) {
    var this$26 = $m_Lcom_github_breakout$undscalajs_GameUtil$();
    this$26.reload__T__V("YOU WIN, CONGRATULATIONS!")
  }
});
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.clear__V = (function() {
  this.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().clearRect(0.0, 0.0, $uI(this.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().width), $uI(this.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().height))
});
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D = (function() {
  return this.canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().getContext("2d")
});
var $d_Lcom_github_breakout$undscalajs_Drawer$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_Drawer$: 0
}, false, "com.github.breakout_scalajs.Drawer$", {
  Lcom_github_breakout$undscalajs_Drawer$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_Drawer$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_Drawer$;
var $n_Lcom_github_breakout$undscalajs_Drawer$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_Drawer$() {
  if ((!$n_Lcom_github_breakout$undscalajs_Drawer$)) {
    $n_Lcom_github_breakout$undscalajs_Drawer$ = new $c_Lcom_github_breakout$undscalajs_Drawer$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_Drawer$
}
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_GameUtil$() {
  $c_O.call(this)
}
$c_Lcom_github_breakout$undscalajs_GameUtil$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_GameUtil$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_GameUtil$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_GameUtil$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_GameUtil$.prototype = $c_Lcom_github_breakout$undscalajs_GameUtil$.prototype;
$c_Lcom_github_breakout$undscalajs_GameUtil$.prototype.init___ = (function() {
  return this
});
$c_Lcom_github_breakout$undscalajs_GameUtil$.prototype.reload__T__V = (function(message) {
  $m_sjs_js_timers_package$().clearInterval__sjs_js_timers_SetIntervalHandle__V($m_Lcom_github_breakout$undscalajs_Global$().refreshId$1);
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().alert(message);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().location.reload(true)
});
var $d_Lcom_github_breakout$undscalajs_GameUtil$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_GameUtil$: 0
}, false, "com.github.breakout_scalajs.GameUtil$", {
  Lcom_github_breakout$undscalajs_GameUtil$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_GameUtil$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_GameUtil$;
var $n_Lcom_github_breakout$undscalajs_GameUtil$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_GameUtil$() {
  if ((!$n_Lcom_github_breakout$undscalajs_GameUtil$)) {
    $n_Lcom_github_breakout$undscalajs_GameUtil$ = new $c_Lcom_github_breakout$undscalajs_GameUtil$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_GameUtil$
}
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_Global$() {
  $c_O.call(this);
  this.refreshId$1 = null;
  this.paddlePower$1 = 0;
  this.paddleWidth$1 = 0;
  this.brickRowCount$1 = 0;
  this.brickColumnCount$1 = 0;
  this.brickWidth$1 = 0;
  this.brickHeight$1 = 0;
  this.brickPadding$1 = 0;
  this.brickOffsetTop$1 = 0;
  this.brickOffsetLeft$1 = 0
}
$c_Lcom_github_breakout$undscalajs_Global$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_Global$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_Global$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_Global$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_Global$.prototype = $c_Lcom_github_breakout$undscalajs_Global$.prototype;
$c_Lcom_github_breakout$undscalajs_Global$.prototype.init___ = (function() {
  this.paddlePower$1 = 12;
  this.paddleWidth$1 = 100;
  this.brickRowCount$1 = 12;
  this.brickColumnCount$1 = 8;
  this.brickWidth$1 = 73;
  this.brickHeight$1 = 15;
  this.brickPadding$1 = 10;
  this.brickOffsetTop$1 = 30;
  this.brickOffsetLeft$1 = 30;
  return this
});
var $d_Lcom_github_breakout$undscalajs_Global$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_Global$: 0
}, false, "com.github.breakout_scalajs.Global$", {
  Lcom_github_breakout$undscalajs_Global$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_Global$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_Global$;
var $n_Lcom_github_breakout$undscalajs_Global$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_Global$() {
  if ((!$n_Lcom_github_breakout$undscalajs_Global$)) {
    $n_Lcom_github_breakout$undscalajs_Global$ = new $c_Lcom_github_breakout$undscalajs_Global$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_Global$
}
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_Score$() {
  $c_O.call(this);
  this.coeff$1 = 0;
  this.score$1 = 0
}
$c_Lcom_github_breakout$undscalajs_Score$.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_Score$.prototype.constructor = $c_Lcom_github_breakout$undscalajs_Score$;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_Score$() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_Score$.prototype = $c_Lcom_github_breakout$undscalajs_Score$.prototype;
$c_Lcom_github_breakout$undscalajs_Score$.prototype.init___ = (function() {
  this.coeff$1 = 1;
  this.score$1 = 0;
  return this
});
$c_Lcom_github_breakout$undscalajs_Score$.prototype.drawScore__V = (function() {
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().font = "16px Arial";
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().fillStyle = "#0095DD";
  var qual$1 = $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D();
  var x$1 = ("Score: " + this.score$1);
  qual$1.fillText(x$1, 8.0, 20.0)
});
var $d_Lcom_github_breakout$undscalajs_Score$ = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_Score$: 0
}, false, "com.github.breakout_scalajs.Score$", {
  Lcom_github_breakout$undscalajs_Score$: 1,
  O: 1
});
$c_Lcom_github_breakout$undscalajs_Score$.prototype.$classData = $d_Lcom_github_breakout$undscalajs_Score$;
var $n_Lcom_github_breakout$undscalajs_Score$ = (void 0);
function $m_Lcom_github_breakout$undscalajs_Score$() {
  if ((!$n_Lcom_github_breakout$undscalajs_Score$)) {
    $n_Lcom_github_breakout$undscalajs_Score$ = new $c_Lcom_github_breakout$undscalajs_Score$().init___()
  };
  return $n_Lcom_github_breakout$undscalajs_Score$
}
...
$c_s_LowPriorityImplicits.prototype.wrapBooleanArray__AZ__scm_WrappedArray = (function(xs) {
  return ((xs !== null) ? new $c_scm_WrappedArray$ofBoolean().init___AZ(xs) : null)
});
/** @constructor */
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_Ball() {
  $c_O.call(this);
  this.x$1 = 0;
  this.y$1 = 0;
  this.dx$1 = 0;
...
$c_Lcom_github_breakout$undscalajs_Ball.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_Ball.prototype.constructor = $c_Lcom_github_breakout$undscalajs_Ball;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_Ball() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_Ball.prototype = $c_Lcom_github_breakout$undscalajs_Ball.prototype;
$c_Lcom_github_breakout$undscalajs_Ball.prototype.productPrefix__T = (function() {
  return "Ball"
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.productArity__I = (function() {
  return 4
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Lcom_github_breakout$undscalajs_Ball)) {
    var Ball$1 = $as_Lcom_github_breakout$undscalajs_Ball(x$1);
    return ((((this.x$1 === Ball$1.x$1) && (this.y$1 === Ball$1.y$1)) && (this.dx$1 === Ball$1.dx$1)) && (this.dy$1 === Ball$1.dy$1))
  } else {
    return false
  }
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Lcom_github_breakout$undscalajs_Ball.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.draw__V = (function() {
  var this$1 = $m_Lcom_github_breakout$undscalajs_Drawer$();
  this$1.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().beginPath();
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().arc(this.x$1, this.y$1, this.radius$1, 0.0, 6.283185307179586);
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().fillStyle = "#000000";
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().fill();
  this$1.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().closePath()
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.init___I__I__I__I = (function(x, y, dx, dy) {
  this.x$1 = x;
  this.y$1 = y;
  this.dx$1 = dx;
  this.dy$1 = dy;
...
$c_Lcom_github_breakout$undscalajs_Ball.prototype.next__I__I__Lcom_github_breakout$undscalajs_Ball = (function(dx, dy) {
  return new $c_Lcom_github_breakout$undscalajs_Ball().init___I__I__I__I(((this.x$1 + dx) | 0), ((this.y$1 + dy) | 0), dx, dy)
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.x$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.y$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.dx$1);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.dy$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 4)
});
$c_Lcom_github_breakout$undscalajs_Ball.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $as_Lcom_github_breakout$undscalajs_Ball(obj) {
  return (((obj instanceof $c_Lcom_github_breakout$undscalajs_Ball) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.breakout_scalajs.Ball"))
}
function $isArrayOf_Lcom_github_breakout$undscalajs_Ball(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_breakout$undscalajs_Ball)))
}
function $asArrayOf_Lcom_github_breakout$undscalajs_Ball(obj, depth) {
  return (($isArrayOf_Lcom_github_breakout$undscalajs_Ball(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.breakout_scalajs.Ball;", depth))
}
var $d_Lcom_github_breakout$undscalajs_Ball = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_Ball: 0
}, false, "com.github.breakout_scalajs.Ball", {
  Lcom_github_breakout$undscalajs_Ball: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_breakout$undscalajs_Ball.prototype.$classData = $d_Lcom_github_breakout$undscalajs_Ball;
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_Brick() {
  $c_O.call(this);
  this.c$1 = 0;
  this.r$1 = 0;
  this.color$1 = null;
...
$c_Lcom_github_breakout$undscalajs_Brick.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_Brick.prototype.constructor = $c_Lcom_github_breakout$undscalajs_Brick;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_Brick() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_Brick.prototype = $c_Lcom_github_breakout$undscalajs_Brick.prototype;
$c_Lcom_github_breakout$undscalajs_Brick.prototype.productPrefix__T = (function() {
  return "Brick"
});
$c_Lcom_github_breakout$undscalajs_Brick.prototype.productArity__I = (function() {
  return 3
});
$c_Lcom_github_breakout$undscalajs_Brick.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Lcom_github_breakout$undscalajs_Brick)) {
    var Brick$1 = $as_Lcom_github_breakout$undscalajs_Brick(x$1);
    return (((this.c$1 === Brick$1.c$1) && (this.r$1 === Brick$1.r$1)) && (this.color$1 === Brick$1.color$1))
  } else {
    return false
  }
});
$c_Lcom_github_breakout$undscalajs_Brick.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.c$1;
      break
...
$c_Lcom_github_breakout$undscalajs_Brick.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_breakout$undscalajs_Brick.prototype.draw__V = (function() {
  var this$1 = $m_Lcom_github_breakout$undscalajs_Drawer$();
  this$1.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().beginPath();
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().rect(this.x$1, this.y$1, $m_Lcom_github_breakout$undscalajs_Global$().brickWidth$1, $m_Lcom_github_breakout$undscalajs_Global$().brickHeight$1);
  var jsx$1 = $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D();
  var s = this.color$1;
  jsx$1.fillStyle = s;
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().fill();
  this$1.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().closePath()
});
$c_Lcom_github_breakout$undscalajs_Brick.prototype.init___I__I__T = (function(c, r, color) {
  this.c$1 = c;
  this.r$1 = r;
  this.color$1 = color;
  this.x$1 = (($imul(c, (($m_Lcom_github_breakout$undscalajs_Global$().brickWidth$1 + $m_Lcom_github_breakout$undscalajs_Global$().brickPadding$1) | 0)) + $m_Lcom_github_breakout$undscalajs_Global$().brickOffsetLeft$1) | 0);
  this.y$1 = (($imul(r, (($m_Lcom_github_breakout$undscalajs_Global$().brickHeight$1 + $m_Lcom_github_breakout$undscalajs_Global$().brickPadding$1) | 0)) + $m_Lcom_github_breakout$undscalajs_Global$().brickOffsetTop$1) | 0);
  return this
});
$c_Lcom_github_breakout$undscalajs_Brick.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.c$1);
...
$c_Lcom_github_breakout$undscalajs_Brick.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $as_Lcom_github_breakout$undscalajs_Brick(obj) {
  return (((obj instanceof $c_Lcom_github_breakout$undscalajs_Brick) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.breakout_scalajs.Brick"))
}
function $isArrayOf_Lcom_github_breakout$undscalajs_Brick(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_breakout$undscalajs_Brick)))
}
function $asArrayOf_Lcom_github_breakout$undscalajs_Brick(obj, depth) {
  return (($isArrayOf_Lcom_github_breakout$undscalajs_Brick(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.breakout_scalajs.Brick;", depth))
}
var $d_Lcom_github_breakout$undscalajs_Brick = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_Brick: 0
}, false, "com.github.breakout_scalajs.Brick", {
  Lcom_github_breakout$undscalajs_Brick: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_breakout$undscalajs_Brick.prototype.$classData = $d_Lcom_github_breakout$undscalajs_Brick;
/** @constructor */
function $c_Lcom_github_breakout$undscalajs_Paddle() {
  $c_O.call(this);
  this.x$1 = 0;
  this.paddleHeight$1 = 0;
  this.paddleWidth$1 = 0
}
$c_Lcom_github_breakout$undscalajs_Paddle.prototype = new $h_O();
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.constructor = $c_Lcom_github_breakout$undscalajs_Paddle;
/** @constructor */
function $h_Lcom_github_breakout$undscalajs_Paddle() {
  /*<skip>*/
}
$h_Lcom_github_breakout$undscalajs_Paddle.prototype = $c_Lcom_github_breakout$undscalajs_Paddle.prototype;
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.productPrefix__T = (function() {
  return "Paddle"
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.productArity__I = (function() {
  return 1
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Lcom_github_breakout$undscalajs_Paddle)) {
    var Paddle$1 = $as_Lcom_github_breakout$undscalajs_Paddle(x$1);
    return (this.x$1 === Paddle$1.x$1)
  } else {
    return false
  }
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.x$1;
      break
...
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.draw__V = (function() {
  var this$1 = $m_Lcom_github_breakout$undscalajs_Drawer$();
  this$1.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().beginPath();
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().rect(this.x$1, (($uI($m_Lcom_github_breakout$undscalajs_Drawer$().canvas__Lorg_scalajs_dom_raw_HTMLCanvasElement().height) - this.paddleHeight$1) | 0), this.paddleWidth$1, this.paddleHeight$1);
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().fillStyle = "#000000";
  $m_Lcom_github_breakout$undscalajs_Drawer$().ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().fill();
  this$1.ctx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D().closePath()
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.init___I = (function(x) {
  this.x$1 = x;
  this.paddleHeight$1 = 10;
  var x1 = $m_Lcom_github_breakout$undscalajs_Global$().paddleWidth$1;
  switch (x1) {
    default: {
      var jsx$1 = ((x1 > 10) ? x1 : 10)
    }
  };
  this.paddleWidth$1 = jsx$1;
  return this
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, this.x$1);
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 1)
});
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $as_Lcom_github_breakout$undscalajs_Paddle(obj) {
  return (((obj instanceof $c_Lcom_github_breakout$undscalajs_Paddle) || (obj === null)) ? obj : $throwClassCastException(obj, "com.github.breakout_scalajs.Paddle"))
}
function $isArrayOf_Lcom_github_breakout$undscalajs_Paddle(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_github_breakout$undscalajs_Paddle)))
}
function $asArrayOf_Lcom_github_breakout$undscalajs_Paddle(obj, depth) {
  return (($isArrayOf_Lcom_github_breakout$undscalajs_Paddle(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcom.github.breakout_scalajs.Paddle;", depth))
}
var $d_Lcom_github_breakout$undscalajs_Paddle = new $TypeData().initClass({
  Lcom_github_breakout$undscalajs_Paddle: 0
}, false, "com.github.breakout_scalajs.Paddle", {
  Lcom_github_breakout$undscalajs_Paddle: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lcom_github_breakout$undscalajs_Paddle.prototype.$classData = $d_Lcom_github_breakout$undscalajs_Paddle;
/** @constructor */
...
$c_sci_Range.prototype.toString__T = (function() {
  ...
  return (((((prefix + "Range ") + this.start$4) + " until ") + this.end$4) + stepped)
});
...
$c_sci_Range.prototype.scala$collection$immutable$Range$$validateMaxLength__V = (function() {
  if ((this.scala$collection$immutable$Range$$numRangeElements$4 < 0)) {
    $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(this.start$4, this.end$4, this.step$4, false)
  }
});
...
$c_sci_Range.prototype.length__I = (function() {
  return ((this.scala$collection$immutable$Range$$numRangeElements$4 < 0) ? $m_sci_Range$().scala$collection$immutable$Range$$fail__I__I__I__Z__sr_Nothing$(this.start$4, this.end$4, this.step$4, false) : this.scala$collection$immutable$Range$$numRangeElements$4)
});
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$m_Lcom_github_breakout$undscalajs_App$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=breakout-fastopt.js.map
